...
//        assertThat(technicalRecord1.getMakeModel().getDtpCode()).isEqualTo(null);
...
//        assertThat(technicalRecord1.getRoadFriendly()).isEqualTo(true);
        ...
        assertThat(technicalRecord1.getManufactureYear()).isEqualTo("base64:type13:MjAxOA=="); //todo check with Rob
...
//        assertThat(technicalRecord1.getDrawbarCouplingFitted()).isEqualTo(true);
        ...
        assertThat(technicalRecord1.getFrontAxleTo5thWheelCouplingMin()).isEqualTo("178202");
        ...
        assertThat(technicalRecord1.getBrakes().get(0).getBrakeCode()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getDataTrBrakeOne()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getDataTrBrakeTwo()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getDataTrBrakeThree()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getRetarderBrakeOne()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getRetarderBrakeTwo()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getBrakeCodeOriginal()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getParkingBrakeForceA()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getParkingBrakeForceB()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getServiceBrakeForceA()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getServiceBrakeForceB()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getSecondaryBrakeForceA()).isEqualTo(null);
        assertThat(technicalRecord1.getBrakes().get(0).getSecondaryBrakeForceB()).isEqualTo(null);
        assertThat(technicalRecord1.getAxles().get(0).getTyres().get(0).getTyreCode()).isEqualTo(1234);
        ...
        assertThat(technicalRecord1.getAxles().get(0).getTyres().get(0).getSpeedCategorySymbol()).isEqualTo("a7");
        assertThat(technicalRecord1.getAxles().get(0).getGbWeight()).isEqualTo(1400);
        ...
        assertThat(technicalRecord1.getAxles().get(0).getBrakeActuator()).isEqualTo(null);
//        assertThat(technicalRecord1.getParkingBrakeMrk()).isEqualTo(true);
//        assertThat(technicalRecord1.getAxles().get(0).getSpringBrakeParking()).isEqualTo(1);
        assertThat(technicalRecord1.getAxles().get(0).getTyres().get(1).getTyreCode()).isEqualTo(5678);
        ...
        assertThat(technicalRecord1.getAxles().get(0).getTyres().get(1).getSpeedCategorySymbol()).isEqualTo("a7");
...
//        assertThat(technicalRecord1.getAxles().get(1).getSpringBrakeParking()).isEqualTo(1);
        assertThat(technicalRecord1.getAxles().get(0).getTyres().get(2).getTyreCode()).isEqualTo(5678);
        ...
        assertThat(technicalRecord1.getAxles().get(0).getTyres().get(2).getSpeedCategorySymbol()).isEqualTo("a7");
        assertThat(technicalRecord1.getAxles().get(2).getGbWeight()).isEqualTo(1600);
        ...
        assertThat(technicalRecord1.getAxles().get(2).getBrakeActuator()).isEqualTo(113);
...
//        assertThat(technicalRecord2.getOffRoad()).isEqualTo(true);
        ...
        assertThat(technicalRecord2.getCreatedAt()).isEqualTo("2019-06-24 10:26:55.000000");
...
//        assertThat(technicalRecord2.getMakeModel().getDtpCode()).isEqualTo(null);
        ...
        assertThat(technicalRecord2.getStatusCode()).isEqualTo("archived");
...
//        assertThat(technicalRecord2.getRoadFriendly()).isEqualTo(true);
        ...
        assertThat(technicalRecord2.getVehicleClass().getEuVehicleCategory()).isEqualTo(null);
        ...
        assertThat(technicalRecord2.getLastUpdatedAt()).isEqualTo("2021-03-19 02:31:45.000000");
        ...
        assertThat(technicalRecord2.getManufactureYear()).isEqualTo("base64:type13:MjAxOA=="); //todo check with Rob
...
//        assertThat(technicalRecord2.getLoadSensingValve()).isEqualTo(true);
        ...
        assertThat(technicalRecord2.getReasonForCreation()).isEqualTo("new trailer");
...
//        assertThat(technicalRecord2.getDrawbarCouplingFitted()).isEqualTo(true);
        ...
        assertThat(technicalRecord2.getFrontAxleTo5thWheelCouplingMin()).isEqualTo("178202");
        ...
        assertThat(technicalRecord2.getBrakes().get(0).getBrakeCode()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getDataTrBrakeOne()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getDataTrBrakeTwo()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getDataTrBrakeThree()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getRetarderBrakeOne()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getRetarderBrakeTwo()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getBrakeCodeOriginal()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getParkingBrakeForceA()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getParkingBrakeForceB()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getServiceBrakeForceA()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getServiceBrakeForceB()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getSecondaryBrakeForceA()).isEqualTo(null);
        assertThat(technicalRecord2.getBrakes().get(0).getSecondaryBrakeForceB()).isEqualTo(null);
